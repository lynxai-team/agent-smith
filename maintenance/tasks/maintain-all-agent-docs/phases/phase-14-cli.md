...
- **Target File:** `/workspace/agent-smith/packages/cli/.agents/documentation/codebase-summary.md`
...
**Execution Plan:**
- Use the `smart-explore` skill to walk `/workspace/agent-smith/packages/cli` directory tree
...
**Execution Plan:**
- Read existing `/workspace/agent-smith/packages/cli/.agents/documentation/codebase-summary.md` (if exists)
