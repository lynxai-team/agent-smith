# Phase 5: Create agent-smith-apps AGENTS.md

## Context
- **Task ID:** maintain-all-agent-docs
- **Repo:** `agent-smith-apps` — Applications built on Agent Smith
- **Path:** `/workspace/agent-smith-apps/`
- **Target File:** `/workspace/agent-smith-apps/AGENTS.md`
...
## Phase Goal
Create or update the per-repo AGENTS.md for agent-smith-apps following the procedure's template.

---

### Step 5.1: Explore Repo Structure
**Execution Plan:**
- Walk `/workspace/agent-smith-apps/` directory tree
- Identify key directories (apps, debate)
- Note repo-specific conventions
**Success Criteria:**
- [ ] Directory structure documented
- [ ] Key directories identified

### Step 5.2: Read Existing AGENTS.md
**Execution Plan:**
- Read existing `agent-smith-apps/AGENTS.md` (if exists)
- Note what's missing or outdated
**Success Criteria:**
- [ ] Current state of documentation assessed

### Step 5.3: Write Per-Repo AGENTS.md
**Execution Plan:**
