...
- **Target File:** `/workspace/lynx-coder/.agents/documentation/codebase-summary.md`
...
**Execution Plan:**
- Use the `smart-explore` skill to walk `/workspace/lynx-coder` directory tree
...
**Execution Plan:**
- Read existing `/workspace/lynx-coder/.agents/documentation/codebase-summary.md` (if exists)
