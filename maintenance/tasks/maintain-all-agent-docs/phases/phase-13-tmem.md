...
- **Target File:** `/workspace/agent-smith/packages/tmem/.agents/documentation/codebase-summary.md`
...
**Execution Plan:**
- Use the `smart-explore` skill to walk `/workspace/agent-smith/packages/tmem` directory tree
...
**Execution Plan:**
- Read existing `/workspace/agent-smith/packages/tmem/.agents/documentation/codebase-summary.md` (if exists)
